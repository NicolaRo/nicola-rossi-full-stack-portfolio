            ...
            <h1>
                ...
                <div className="skills-bar">
                    <img className="language-icon" src={ HTMLLogo} alt="HTML-logo"/>
                        <div className="bar back intermediate" data-skill="HTML" ></div>
                </div>

                <div className="skills-bar">
                    <img className="language-icon" src={CSSLogo} alt="CSS-logo"/>
                        <div className="bar back intermediate" data-skill="CSS"></div>
                </div>

                <div className="skills-bar">
                    <img className="language-icon" src={JavascriptLogo} alt="Javascript logo"/>
                        <div className="bar front learning" data-skill="JavaScript"></div>
                </div>

                <div className="skills-bar">
                    <img className="language-icon" src={ TypescriptLogo} alt="Typescript logo"/>
                        <div className="bar front learning" data-skill="Typescript"></div>
                </div>
